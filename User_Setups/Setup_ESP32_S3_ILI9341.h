...
#define TFT_CS   41 // 17 34 //     10 or 34 (FSPI CS0) 
#define TFT_MOSI 2 //19 35 //     11 or 35 (FSPI D)
#define TFT_SCLK 1 //18 36 //     12 or 36 (FSPI CLK)
#define TFT_MISO 42 //16 37 //     13 or 37 (FSPI Q)

// Use pins in range 0-31
#define TFT_DC  4  //20 7
#define TFT_RST 5  //21 6
